...
},{"@babel/runtime/helpers/esm/objectSpread2":"../node_modules/@babel/runtime/helpers/esm/objectSpread2.js"}],"app.ts":[function(require,module,exports) {
"use strict";
...
var Actions;
(function (Actions) {
  Actions["CREATE_POLICY"] = "CREATE_POLICY";
  Actions["DELETE_POLICY"] = "DELETE_POLICY";
  Actions["CREATE_CLAIM"] = "CREATE_CLAIM";
})(Actions || (Actions = {}));
var createPolicyForm = function createPolicyForm(name, money) {
  return {
...
var deletePolicyForm = function deletePolicyForm(name, money) {
  return {
...
var createClaimForm = function createClaimForm(name, money) {
  return {
...
//departments
var accounting = function accounting(money, form) {
  if (money === void 0) {
    money = 0;
  }
...
var policies = function policies(listofPolicies, form) {
  if (listofPolicies === void 0) {
    listofPolicies = [];
  }
  if (form.type === Actions.CREATE_POLICY) {
    return __spreadArray(__spreadArray([], listofPolicies, true), [form.payload.name], false);
  } else if (form.type === Actions.DELETE_POLICY) {
    return listofPolicies.filter(function (names) {
      return names !== form.payload.name;
    });
  }
  return listofPolicies;
};
var claims = function claims(listofClaims, form) {
  if (listofClaims === void 0) {
    listofClaims = [];
  }
  if (form.type === Actions.CREATE_CLAIM) {
    return __spreadArray(__spreadArray([], listofClaims, true), [form.payload.name], false);
  }
  return listofClaims;
};
var state = (0, redux_1.combineReducers)({
  accounting: accounting,
  policies: policies,
  claims: claims
});
var store = (0, redux_1.createStore)(state);
store.dispatch(createPolicyForm('Piera', 4000));
store.dispatch(createPolicyForm('Cynthia', 4000));
store.dispatch(createPolicyForm('Onan', 4000));
store.dispatch(createPolicyForm('Ian', 4000));
store.dispatch(createClaimForm('Cynthia', 4000));
store.dispatch(createClaimForm('Onan', 7000));
console.log(store.getState());
},{"redux":"../node_modules/redux/es/redux.js"}],"../../AppData/Roaming/nvm/v18.13.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../AppData/Roaming/nvm/v18.13.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.ts"], null)
